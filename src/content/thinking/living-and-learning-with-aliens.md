---
title: "Living & Learning With Aliens: The Complex Psychology of AI Anthropomorphism"
description: "A panel exploring what it means to live and learn alongside AI — and the case for building friction back in."
type: "talk"
...
**There's a <a href="https://youtube.com/shorts/nPvEmQjCph0" target="_blank" rel="noopener noreferrer">viral clip of a Boston cop going down a playground slide</a>.** It's frictionless, and the cop shoots off the end into the air. That's the design failure mode. The job of a learning designer is to build the friction back in.
...
<div style="width: 100vw; position: relative; left: 50%; transform: translateX(-50%); max-width: 1200px; margin-top: 2rem;">
  <iframe src="https://www.youtube.com/embed/pIti7HVYky0" style="width: 100%; aspect-ratio: 16/9; border: 1px solid #EBE6E0; border-radius: 8px;" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen title="Living & Learning With Aliens: ASU+GSV Summit 2026"></iframe>
</div>
